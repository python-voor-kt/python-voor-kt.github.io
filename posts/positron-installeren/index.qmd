...
1. Zorg dat je weet wat voor type processor je hebt. MacBooks uitgebracht sinds november 2020 hebben allemaal een Apple Silicon-processor. MacBooks van van voor half 2020 hebben allemaal een Intel-processor.
    - Klik op het Apple-logo in de menubalk en dan op 'Over deze Mac'.
    - Achter 'Processor' staat ofwel "**Apple** M..." ofwel "... **Intel** Core ...".
2. Download en installeer 'Positron':
    ...
    - Er opent een venster met 'Positron.app' en 'Applications'. Klik en sleep Positron bovenop Applications om Positron te installeren. Sluit daarna venster. 
      ![Het installatie-venster voor Positron.](install-positron.png)
