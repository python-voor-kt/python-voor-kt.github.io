...
1. Zorg dat je weet wat voor type processor je hebt[^platform]: een x64-processor (Intel of AMD) of een ARM-processor:
...
3. Het kan zijn dat je computer vraagt om commandoregeltools te installeren. Klik op "Annuleren".
